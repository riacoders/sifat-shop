    ...
    <div className="max-w-full flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-64 h-full p-4">
      ...
      <div className="w-full lg:w-3/5 bg-white shadow-md rounded-md p-6">
        ...
        <div className="max-w-xl mx-auto p-2 border-2 mt-4">
          <div className="bg-gray-100 border-l-4 border-orange-400 p-4 mb-6">
            ...
            <p className="text-sm text-orange-500">
              В заказе есть товары находящиеся на складе поставщика, которые могут быть доставлены на день позже.
              <span className="font-bold text-orange-600"> Экспресс-доставка</span> с такими товарами не доступна.
            </p>
          </div>
        </div>
        ...
        <div className="w-full mx-auto bg-white shadow-md rounded-md p-6 mt-4">
          ...
          <label className="block mb-2 text-sm font-medium text-gray-700">Ko'cha, uy, bino, kvartira</label>
          <input
            type="text"
          ...
          <label className="block mb-2 text-sm font-medium text-gray-700">Ism</label>
          <input
            type="text"
            className="w-full p-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            value=""
          ...
          <label className="block mb-2 text-sm font-medium text-gray-700">Telefon nomer </label>
          <input
            type="text"
            className="w-full p-2 mb-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder="+998 (##) ###-##-##"
          ...
          <h2 className="text-xl font-semibold mb-4">Buyurtma bo'yicha sharhlar</h2>
      ...
      <div className="w-full lg:w-1/4 bg-white shadow-md rounded-md p-6">
        ...
        <button className="w-full bg-indigo-500 text-white py-2 rounded-md hover:bg-indigo-600 mb-4">Оформить заказ</button>
        ...
        {promoInputVisible && (
          <div className="mt-4">
            ...
            />
            <button className="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 mt-2">Применить</button>
          </div>
        )}
      </div>
    </div>
