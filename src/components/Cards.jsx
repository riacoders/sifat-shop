	...
	return (
		<div className='flex'>
			<div className='w-1/4 p-4 border-r border-gray-200'>
				<div className='mb-4'>
					<h2 className='text-xl font-semibold mb-2'>Kategoriyalar</h2>
					<div>
				...
				<div className='mb-4'>
					<h2 className='text-xl font-semibold mb-2'>Наличие</h2>
					<div>
						<label className='block'>
							<input type='checkbox' className='mr-2 w-4 h-4' />В магазине
							Bulavka
						</label>
						<label className='block'>
				...
				<div className='mb-4'>
					<h2 className='text-xl font-semibold mb-2'>Размер</h2>
					<div className='grid grid-cols-2 gap-2'>
						<label className='block'>
							<input type='checkbox' className='mr-2 w-4 h-4 ' /> 2XL
						</label>
						<label className='block'>
							<input type='checkbox' className='mr-2 w-4 h-4 ' /> 46
						</label>
						<label className='block'>
							<input type='checkbox' className='mr-2 w-4 h-4 ' /> 48
						</label>
						<label className='block'>
							<input type='checkbox' className='mr-2 w-4 h-4 ' /> 50
						</label>
						<label className='block'>
							<input type='checkbox' className='mr-2 w-4 h-4 ' /> 54
						</label>
						<label className='block'>
							<input type='checkbox' className='mr-2 w-4 h-4 ' /> L
						</label>
					</div>
				</div>

				<div className='mb-4'>
					<h2 className='text-xl font-semibold mb-2'>Цвет</h2>
					<div>
						<div>
							{colors.map(color => (
						...
						popular.map(item => (
							<div className='flex flex-col gap-1' key={item.id}>
								<div className='relative flex   p-2 overflow-hidden rounded-md h-[350px] w-[250px]'>
									...
									<span className='absolute  rounded-md  w-10 h-5  bg-orange-500 text-white flex items-center justify-start z-10 font-semibold'>
										{item.discount}
									</span>
