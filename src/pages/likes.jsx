					...
					return (
						<div className='flex flex-col gap-1 shadow-sm' key={index}>
							<div className='relative flex items-center justify-center p-2 overflow-hidden border-solid border-2 border-slate-300 rounded-md h-[250px]'>
								...
								<span className='absolute top-0 left-2 w-12 h-12 rounded-full bg-blue-800 text-white flex items-center justify-center z-10 font-semibold'>
									{item.discount}
								</span>
								<CiHeart className='absolute bottom-2 right-2 text-4xl text-white cursor-pointer hover:text-red-500 bg-blue-600 p-1 rounded-full' />{' '}
